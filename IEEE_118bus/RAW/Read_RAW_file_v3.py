...
#    # -------------------------------------------------------------------------
    ...
    # Qgen rows
    QGenList                = ['incoming', 'Qe'] + QGenList     
    ws_Pins.append(QGenList)    
    # Pgen rows
    statusGenList           = ['incoming', 'status_Gen'] + statusGenList
    ws_Pins.append(statusGenList)
    # Vref rows
    ExciterList             = ['incoming', 'Exciter Vref'] + ExciterList
    ws_Pins.append(ExciterList)
